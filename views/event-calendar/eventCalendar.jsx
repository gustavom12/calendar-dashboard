...
function EventCalendar({ intl, uniqueTab = false }) {
  ...
  return (
    <div className="eventCalendar">
      <div style={{ marginTop: uniqueTab ? 30 : 80 }} className="card">
        {!uniqueTab ? (
          windowwidth > 800 ? (
            <>
        ...
        {(uniqueTab === "typeofevent" || activeTab === "typeofevent") && (
          <TypeofEvent />
        )}
        {!uniqueTab && activeTab === "events" && (
          <SavedEvents timezone={timezone} />
        )}
        {!uniqueTab && activeTab === "calendarconection" && (
          <CalendarConnection />
        )}
      </div>
    </div>
